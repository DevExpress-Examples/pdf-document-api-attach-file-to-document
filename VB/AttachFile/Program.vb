    ...
    Friend Class Program
        Shared Sub Main(ByVal args() As String)
            ...
            Using processor As New PdfDocumentProcessor()
                ...
                processor.AttachFile(New PdfFileAttachment() With {.CreationDate = Date.Now, .Description = "This is my attach file.", .MimeType = "text/plain", .FileName = "MyAttach.txt", .Data = GetData()})
